...
// import './style.css'
import {fullscreen} from "@gaopeng123/utils";
...
export const createWord = function (el: Element) {
    const isApple =
        typeof navigator !== 'undefined' && /Mac OS X/.test(navigator.userAgent)

    // 1. 初始化编辑器
    const container = el.querySelector<HTMLDivElement>('.editor')!
    ...
    window.addEventListener(
        'click',
        evt => {
            const visibleDom = el.querySelector('.visible')
    ...
    // 2. | 撤销 | 重做 | 格式刷 | 清除格式 |
    const undoDom = el.querySelector<HTMLDivElement>('.menu-item__undo')!
    ...
    const redoDom = el.querySelector<HTMLDivElement>('.menu-item__redo')!
    ...
    const painterDom = el.querySelector<HTMLDivElement>(
        '.menu-item__painter'
    )!
    ...
    el.querySelector<HTMLDivElement>('.menu-item__format')!.onclick =
        function () {
            console.log('format')
    ...
    const fontDom = el.querySelector<HTMLDivElement>('.menu-item__font')!
    ...
    const sizeSetDom = el.querySelector<HTMLDivElement>('.menu-item__size')!
    ...
    const sizeAddDom = el.querySelector<HTMLDivElement>(
        '.menu-item__size-add'
    )!
    ...
    const sizeMinusDom = el.querySelector<HTMLDivElement>(
    ...
    const boldDom = el.querySelector<HTMLDivElement>('.menu-item__bold')!
    ...
    const italicDom =
        el.querySelector<HTMLDivElement>('.menu-item__italic')!
    ...
    const underlineDom = el.querySelector<HTMLDivElement>(
    ...
    const strikeoutDom = el.querySelector<HTMLDivElement>(
    ...
    const superscriptDom = el.querySelector<HTMLDivElement>(
    ...
    const subscriptDom = el.querySelector<HTMLDivElement>(
    ...
    const colorControlDom = el.querySelector<HTMLInputElement>('#color')!
    colorControlDom.oninput = function () {
        instance.command.executeColor(colorControlDom.value)
    }
    const colorDom = el.querySelector<HTMLDivElement>('.menu-item__color')!
    ...
    const titleDom = el.querySelector<HTMLDivElement>('.menu-item__title')!
    ...
    const leftDom = el.querySelector<HTMLDivElement>('.menu-item__left')!
    ...
    const centerDom =
        el.querySelector<HTMLDivElement>('.menu-item__center')!
    ...
    const rightDom = el.querySelector<HTMLDivElement>('.menu-item__right')!
    ...
    const alignmentDom = el.querySelector<HTMLDivElement>(
    ...
    const justifyDom = el.querySelector<HTMLDivElement>(
        '.menu-item__justify'
    )!
    ...
    const rowMarginDom = el.querySelector<HTMLDivElement>(
    ...
    const listDom = el.querySelector<HTMLDivElement>('.menu-item__list')!
    ...
    const tableDom = el.querySelector<HTMLDivElement>('.menu-item__table')!
    const tablePanelContainer = el.querySelector<HTMLDivElement>(
        '.menu-item__table__collapse'
    )!
    const tableClose = el.querySelector<HTMLDivElement>('.table-close')!
    const tableTitle = el.querySelector<HTMLDivElement>('.table-select')!
    const tablePanel = el.querySelector<HTMLDivElement>('.table-panel')!
    // 绘制行列
    ...
    const imageDom = el.querySelector<HTMLDivElement>('.menu-item__image')!
    const imageFileDom = el.querySelector<HTMLInputElement>('#image')!
    ...
    const hyperlinkDom = el.querySelector<HTMLDivElement>(
    ...
    const separatorDom = el.querySelector<HTMLDivElement>(
    ...
    const pageBreakDom = el.querySelector<HTMLDivElement>(
    ...
    const watermarkDom = el.querySelector<HTMLDivElement>(
    ...
    const codeblockDom = el.querySelector<HTMLDivElement>(
    ...
    const controlDom = el.querySelector<HTMLDivElement>(
        '.menu-item__control'
    )!
    ...
    const checkboxDom = el.querySelector<HTMLDivElement>(
        '.menu-item__checkbox'
    )!
    ...
    const radioDom = el.querySelector<HTMLDivElement>('.menu-item__radio')!
    ...
    const latexDom = el.querySelector<HTMLDivElement>('.menu-item__latex')!
    latexDom.onclick = function () {
        console.log('LaTeX')
    }

    const dateDom = el.querySelector<HTMLDivElement>('.menu-item__date')!
    ...
    const blockDom = el.querySelector<HTMLDivElement>('.menu-item__block')!
    blockDom.onclick = function () {
        console.log('block')
    }

    // 5. | 搜索&替换 | 打印 |
    const searchCollapseDom = el.querySelector<HTMLDivElement>(
        '.menu-item__search__collapse'
    )!
    const searchInputDom = el.querySelector<HTMLInputElement>(
        '.menu-item__search__collapse__search input'
    )!
    const replaceInputDom = el.querySelector<HTMLInputElement>(
        '.menu-item__search__collapse__replace input'
    )!
    const searchDom =
        el.querySelector<HTMLDivElement>('.menu-item__search')!
    ...
    const printDom = el.querySelector<HTMLDivElement>('.menu-item__print')!
    ...
    const editorOptionDom =
        el.querySelector<HTMLDivElement>('.editor-option')!
    ...
    async function updateCatalog() {
        ...
        const catalogMainDom =
            el.querySelector<HTMLDivElement>('.catalog__main')!
    ...
    const catalogDom = el.querySelector<HTMLElement>('.catalog')!
    const catalogModeDom =
        el.querySelector<HTMLDivElement>('.catalog-mode')!
    const catalogHeaderCloseDom = el.querySelector<HTMLDivElement>(
    ...
    const pageModeDom = el.querySelector<HTMLDivElement>('.page-mode')!
    ...
    el.querySelector<HTMLDivElement>('.page-scale-percentage')!.onclick =
        function () {
            console.log('page-scale-recovery')
            instance.command.executePageScaleRecovery()
        }

    el.querySelector<HTMLDivElement>('.page-scale-minus')!.onclick =
        function () {
            console.log('page-scale-minus')
            instance.command.executePageScaleMinus()
        }

    el.querySelector<HTMLDivElement>('.page-scale-add')!.onclick =
        function () {
    ...
    // 纸张大小
    const paperSizeDom = el.querySelector<HTMLDivElement>('.paper-size')!
    ...
    const paperDirectionDom =
        el.querySelector<HTMLDivElement>('.paper-direction')!
    ...
    const paperMarginDom =
        el.querySelector<HTMLDivElement>('.paper-margin')!
    ...
    // 全屏
    const fullscreenDom = el.querySelector<HTMLDivElement>('.fullscreen')!
    fullscreenDom.onclick = ()=> fullscreen(document.body, {});
    ...
    const modeElement = el.querySelector<HTMLDivElement>('.editor-mode')!
    modeElement.onclick = function () {
        ...
        el.querySelectorAll<HTMLDivElement>('.menu-item>div').forEach(dom => {
    ...
    // 模拟批注
    const commentDom = el.querySelector<HTMLDivElement>('.comment')!
    ...
    instance.listener.visiblePageNoListChange = function (payload) {
        ...
        el.querySelector<HTMLSpanElement>('.page-no-list')!.innerText = text
    }

    instance.listener.pageSizeChange = function (payload) {
        el.querySelector<HTMLSpanElement>(
            '.page-size'
        )!.innerText = `${payload}`
    }

    instance.listener.intersectionPageNoChange = function (payload) {
        el.querySelector<HTMLSpanElement>('.page-no')!.innerText = `${
            payload + 1
        }`
    }
    ...
    instance.listener.controlChange = function (payload) {
        ...
        disableMenusInControlContext.forEach(menu => {
            const menuDom = el.querySelector<HTMLDivElement>(
                `.menu-item__${menu}`
            )!
            payload
    ...
    const handleContentChange = async function () {
        ...
        el.querySelector<HTMLSpanElement>('.word-count')!.innerText = `${
            wordCount || 0
        }`
        // 目录
        if (isCatalogShow) {
